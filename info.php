  ...
  <div class="container">
             <h2>Wat houdt elke opdleiding in?</h2> <br>       
                <h4 class="opleiding">• Medewerker ICT support (niveau 2)</h4>
                    ...
                    <p>Als (aankomend) medewerker ICT houd je je bezig met de volgende zaken:
                    Gebruiksklaar maken van systemen, applicaties en apparatuur
                    Repareren en vervangen van systemen en apparatuur
                    Verwerken van incidentmeldingen
                ...
                <h4 class="opleiding">• Allround medewerker IT systems and devices / Expert IT systems and devices (N3/4)</h4>
                    ...
                    Instructies opschrijven en mondeling toelichten
                    Gebruiksklaar maken van systemen, applicaties en apparatuur
                    Repareren en vervangen van systemen en apparatuur
                    Verwerken van incidentmeldingen
                    Oplossen van incidenten
                    Je werkt zelfstandig of in een team. Je kunt gaan werken bij een ICT-dienstverlenend bedrijf of op de ICT-afdeling van een bedrijf.
                    </p>
                    <br>
                <h2>Tijden van de open dagen</h2> 
